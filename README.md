...
<p align="center">
  <img src="docs/credential_tool.png" alt="The credential tool panel after a successful capture: API URL, masked Bearer token, masked account ID, download button, and a log of the intercepted calls" width="460">
</p>
